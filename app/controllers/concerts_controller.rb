class ConcertsController < ApplicationController
  ...
  def  report(exception, handled, severity, context, source)
    errors << exception.to_str
  end
  ...
  def destroy
    ...
    respond_to do |format|
      format.html { redirect_to concerts_path, status: :see_other, notice: "Concert was successfully destroyed." }
  ...
  def register
    ...
    def concert_params
      params.require(:concert).permit(:title, :group_id, :venue_id)
    end
end
